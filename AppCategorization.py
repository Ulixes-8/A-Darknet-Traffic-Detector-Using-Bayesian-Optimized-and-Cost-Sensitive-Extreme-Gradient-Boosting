...
# ##RANKED TOP 15 FEATURES (FROM BEST TO LEAST BEST). 
# ##COMMENT OUT BOTTOM 5-10 TO GET CLASSIFICATION RESULTS FOR EACH TOP 10/TOP 5 
# df = pd.DataFrame(data, columns= ['Dst_Port',
...
# title = "Decision Tree (TOP 20) Confusion Matrix (DB)"
...
title = "Random Forest (TOP 20) Confusion Matrix (DB)"
plot_matrix(cm, classes, title)
print(conf_mat)
...
# plt.title("Decision Tree (TOP 20) (DB) PCA", fontsize=16)
plt.title("Random Forest (TOP 20) (PCA)", fontsize=16)
