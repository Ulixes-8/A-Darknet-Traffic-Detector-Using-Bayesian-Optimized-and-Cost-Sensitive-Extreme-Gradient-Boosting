# -*- coding: utf-8 -*-
"""
Created on Tue Sep  6 14:00:19 2022
...
# ## Decision Tree
# dt = tree.DecisionTreeClassifier(random_state=0, max_depth=8)
...
# classes = ['Audio Streaming', 'Browsing', 'Chat', 'Email', 'File Transfer', 'P2P', 'VoIP', 'Video Streaming'] #DB DATABASE
# title = "Decision Tree (TOP 20) Confusion Matrix (DARKNET TRAFFIC)"
...
# title = "Random Forest (TOP 20) Confusion Matrix (DARKNET TRAFFIC)"
# plot_matrix(cm, classes, title)
# print(conf_mat)
...
# # classes = ['Benign', 'Tor', 'VPN'] #VTB DATABASE
# classes = ['Audio Streaming', 'Browsing', 'Chat', 'Email', 'File Transfer', 'P2P', 'VoIP', 'Video Streaming']
# title = "Gaussian Naive Bayes (TOP 20) Confusion Matrix (DARKNET TRAFFIC)"
# plot_matrix(cm, classes, title)
# print(conf_mat)
...
# # classes = ['Benign', 'Tor', 'VPN'] #VTB DATABASE
# classes = ['Audio Streaming', 'Browsing', 'Chat', 'Email', 'File Transfer', 'P2P', 'VoIP', 'Video Streaming']
# title = "LinearSVC (TOP 20) Confusion Matrix (DARKNET TRAFFIC)"
# plot_matrix(cm, classes, title)
# print(conf_mat)
...
# classes = ['Benign', 'Tor', 'VPN'] #VTB DATABASE
classes = ['Audio Streaming', 'Browsing', 'Chat', 'Email', 'File Transfer', 'P2P', 'VoIP', 'Video Streaming']
title = "Multi Layer Perceptron (TOP 20) Confusion Matrix (DARKNET TRAFFIC)"
plot_matrix(cm, classes, title)
print(conf_mat)
...
plt.title("Multi Layer Perceptron (TOP 20) (Darknet Traffic)", fontsize=16)
